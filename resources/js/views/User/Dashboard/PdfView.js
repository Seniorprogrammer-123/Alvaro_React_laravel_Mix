...
const PdfView = (props) => {
    ...
    const handleChange = (file) => {
        ...
        if (file[0] != '') {
            ...
            axios.post('/api/pdfupload/' + id, fd)
                .then(res => {
                    if (res.data.message == "success") {
                        props.history.push('/smssuccess');
                    }
                }
                );
        }
    ...
    return (
        <div className="container">
                ...
                <div className='row justify-content-center'>
                    ...
                    <div className="col-md-12 card">
                        ...
                        <div className="row form-group">
                            ...
                            <div className="col-lg-7">
                                <input type="email" name="email" onChange={inputChange} defaultValue={data.email} />
                            </div>
                        </div>
                        <div className="row form-group">
                    ...
                    <div className="col-md-4">
                        <button className="btn-unagree" onClick={() => setModalVisible(true)} >Ver Foto</button>
                    </div>
                    <div className="col-md-4"></div>
                    <div className="col-md-4"></div>
                    <div className="col-md-4">
                        <input type="file" name="imagepath" id="imagepath" accept=".pdf" style={{ display: 'none' }} onChange={(e) => handleChange(e.target.files)} />
                        <input type="button" className="btn-agree" value="SUBIR PDF" onClick={imageUpload} />
                    </div>
                    <div className="col-md-4"></div>
                    <div className="col-md-4"></div>
                    <div className="col-md-4">
            ...
            <Modal
                ...
                footer={[]}
            >
                <img src={"/uploads/dnis/"+data.imagepath} />
            </Modal>
            <Footer />
        </div>
    );
