...
const Admins = (props) => {
    ...
    const getData = () => {
        ...
        axios.get('/api/users/list/Admin').then(response => {
                ...
                <div className='col-md-12'>
                    ...
                    <table className="table table-hovered table-striped">
                        ...
                        {items.map((item,i)=>(
                            <tr key={i}>
                                ...
                                <td>
                                    <Link className='btn btn-info' to={`/editadmin/${item.id}`} >VER</Link>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <Link className='btn btn-primary btn-agree' to='/createadmin'>AGREGAR</Link>
                        </div>
                        <div className="col-lg-4"></div>
                    </div>
                    <div className="row">
